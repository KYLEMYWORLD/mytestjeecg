...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jformEchartList" checkbox="false" pagination="true" fitColumns="true" title="项目看板信息表" sortName="id" actionUrl="jformEchartController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="项目ID"  field="projectId"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="任务等级"  field="taskLevel"  queryMode="single"  dictionary="planLevel"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="jformEchartController.do?goAdd" funname="add"></t:dgToolBar>
	<t:dgToolBar title="编辑" icon="icon-edit" url="jformEchartController.do?goUpdate" funname="update" id="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="jformEchartController.do?doBatchDel" funname="deleteALLSelect" id="deleteselect"></t:dgToolBar>
