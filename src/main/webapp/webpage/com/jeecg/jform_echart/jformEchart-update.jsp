 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="projectId" name="projectId" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${jformEchartPage.projectId}'/>
						...
						<td class="value">
						    <input id="taskId" name="taskId" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${jformEchartPage.taskId}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="pretaskId" name="pretaskId" type="text" maxlength="36" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformEchartPage.pretaskId}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="taskName" name="taskName" type="text" maxlength="200" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${jformEchartPage.taskName}'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						    <input id="taskShortname" name="taskShortname" type="text" maxlength="50" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${jformEchartPage.taskShortname}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="alertMsg" name="alertMsg" type="text" maxlength="200" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformEchartPage.alertMsg}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="startDate" name="startDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*"  ignore="checked" value='<fmt:formatDate value='${jformEchartPage.startDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="finishDate" name="finishDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*"  ignore="checked" value='<fmt:formatDate value='${jformEchartPage.finishDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
