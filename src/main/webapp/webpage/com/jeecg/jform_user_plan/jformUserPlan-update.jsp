...
<html>
 <head>
  ...
  $(document).ready(function(){
	  ...
	  //$("#planLevel").val("${jformPlanPage.planLevel}");
	  //$("#planLevel").find("option[value='${jformPlanPage.planLevel}']").attr("selected",true);
	  //$("#planLevel").attr("disabled","disabled")

  });
  </script>
 </head>
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jformUserPlanController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="planName" name="planName" type="text" maxlength="50" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformUserPlanPage.planName}'/>
					...
					<tr>
						...
						<td class="value">
							<input id="startDate" readonly name="startDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" value='<fmt:formatDate value='${jformUserPlanPage.startDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
							<input id="finishDate" readonly name="finishDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" value='<fmt:formatDate value='${jformUserPlanPage.finishDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<input id="planId" name="planId" type="text" style="width: 150px" class="inputxt easyui-combotree"  ignore="ignore"
								   value='${jformUserPlanPage.planId}'
								   data-options="
				                    panelHeight:'220',
						...
						<td class="value">
						    <input id="planResponder" name="planResponder" readonly type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformUserPlanPage.planResponder}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value"  colspan="3" >
						  	 	<textarea id="planInfo" style="height:auto;width:95%;" class="inputxt" rows="6" name="planInfo"  ignore="ignore" >${jformUserPlanPage.planInfo}</textarea>
							<span class="Validform_checktip"></span>
