...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jformTaskList" checkbox="false" pagination="true" fitColumns="true" title="工作任务分配表" sortName="createDate" actionUrl="jformTaskController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="项目名称"  field="taskProjectname" query="true"  queryMode="single"  dictionary="project4task,taskProjectid@taskProjectname,id@project_name"  popup="true"  width="120"></t:dgCol>
   ...
   <t:dgDelOpt id="delete" exp="taskStatus#eq#0" title="删除" url="jformTaskController.do?doDel&id={id}" urlclass="ace_button"  urlfont="fa-trash-o" operationCode="delete"/>
   <t:dgFunOpt id="activate" exp="taskStatus#eq#0" funname="doActivate(id)" title="下发" urlclass="ace_button" urlfont="fa-wrench"/>
   <t:dgToolBar id="add" title="录入任务" icon="icon-add" url="jformTaskController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar id="update" title="编辑任务" icon="icon-edit" url="jformTaskController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar id="detail" title="查看" icon="icon-search" url="jformTaskController.do?goUpdate" funname="detail"></t:dgToolBar>
