...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //初始化 控件默认是否勾选
            if($("#morningFree").val()==1){
                $("#morningFree").attr("checked",true);
            }
            if($("#afternoonFree").val()==1){
                $("#afternoonFree").attr("checked",true);
            }
        });
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
             action="jformAttendanceController.do?doUpdate" beforeSubmit="enableInput">
    ...
    <input id="attenStatus" name="attenStatus" type="hidden" value="${jformAttendancePage.attenStatus }"/>
    <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
        <tr>
            ...
            <td class="value">
                <input id="empName" disabled name="empName" type="text" style="width: 150px" class="searchbox-inputtext"
                       datatype="*" ignore="checked"
                       onclick="popupClick(this,'id,realname','empId,empName','user_select_single')"
                       value='${jformAttendancePage.empName}'/>
        ...
        <tr>
            ...
            <td class="value">
                <input id="beginDate" readonly name="beginDate" type="text" style="width: 150px" class="Wdate"
                       ...
                       value='<fmt:formatDate value='${jformAttendancePage.beginDate}' type="date" pattern="yyyy-MM-dd"/>'/>
                不包上午: <input id="morningFree" name="morningFree" type="checkbox"  value="${jformAttendancePage.morningFree}"/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="endDate" readonly name="endDate" type="text" style="width: 150px" class="Wdate"
                       ...
                       value='<fmt:formatDate value='${jformAttendancePage.endDate}' type="date" pattern="yyyy-MM-dd"/>'/>
                不包下午: <input id="afternoonFree" name="afternoonFree" type="checkbox" value="${jformAttendancePage.afternoonFree}"/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <input id="attenDays" name="attenDays" type="text" maxlength="16" style="width: 150px" class="inputxt"
                       datatype="*" ignore="ignore" value='${jformAttendancePage.attenDays}'/>
                <span class="Validform_checktip"></span>
        ...
        <tr>
            ...
            <td class="value">
                <textarea id="memo" style="height:auto;width:95%;" class="inputxt" rows="6" name="memo"
                          ignore="ignore">${jformAttendancePage.memo}</textarea>
                <span class="Validform_checktip"></span>
