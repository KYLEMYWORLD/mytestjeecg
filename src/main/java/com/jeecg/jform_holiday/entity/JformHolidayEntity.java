package com.jeecg.jform_holiday.entity;
 ...
 * @date 2019-01-10 15:51:49
 * @version V1.0   
 *
 */
@Entity
@Table(name = "jform_holiday", schema = "")
@SuppressWarnings("serial")
public class JformHolidayEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="HOLIDAY",nullable=false,length=32)
