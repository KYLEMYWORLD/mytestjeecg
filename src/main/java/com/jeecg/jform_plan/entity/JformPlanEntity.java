package com.jeecg.jform_plan.entity;
 ...
 */
@Entity
@Table(name = "jform_plan", schema = "")
@SuppressWarnings("serial")
public class JformPlanEntity implements java.io.Serializable {
	/**主键*/
	...
	/**项目ID*/
	@Excel(name="项目ID",width=15,dictTable ="jform_project",dicCode ="id",dicText ="project_name")
	private java.lang.String projectId;
	/**分配任务ID*/
	@Excel(name="分配任务ID",width=15,dictTable ="jform_task",dicCode ="id",dicText ="task_name")
	...
	@Column(name ="PLAN_LEVEL",nullable=true,length=32)
	...
	@Column(name ="PLAN_ORDER",nullable=true,length=32)
	...
	@Column(name ="PLAN_INFO",nullable=true,length=300)
	...
	@Column(name ="PLAN_RESPONDERID",nullable=true,length=300)
	...
	@Column(name ="PLAN_STATUS",nullable=true,length=32)
	...
	@Column(name ="PLAN_ISSUCC",nullable=true,length=32)
	...
	@Column(name ="PLAN_ISALERT",nullable=true,length=32)
